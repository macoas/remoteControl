...
public class MouseKeyboardControl {
    ...
    public void typeCharacter(int keyCode) {
        switch (keyCode) {
            ...
            case ButtonEnum.INTELIGIBLE:
                //doType(90);
                doType(VK_A);
                break;
            case ButtonEnum.NOINTELIGIBLE:
                //doType(88);
                doType(VK_B);
                break;
            case ButtonEnum.NSINTELIGIBLE:
                //doType(88);
                doType(VK_C);
                break;
                
            case ButtonEnum.ADECUADO:
                //doType(66);
                doType(VK_D);
                break;
            case ButtonEnum.NOADECUADO:
                //doType(78);
                doType(VK_E);
                break;   
            case ButtonEnum.NSADECUADO:
                //doType(88);
                doType(VK_F);
                break;    
                
            case ButtonEnum.OMISIONES1:
                //doType(81);
                doType(VK_G);
                break;
            case ButtonEnum.OMISIONES2:
                //doType(87);
                doType(VK_H);
                break;
            case ButtonEnum.OMISIONES3:
                //doType(69);
                doType(VK_I);
                break;
            case ButtonEnum.OMISIONES4:
                //doType(82);
                doType(VK_J);
                break;
            case ButtonEnum.NSOMISIONES:
                doType(VK_K);
                break;
                
             case ButtonEnum.FLUIDEZ1:
                //doType(65);
                 doType(VK_L);
                break;
            case ButtonEnum.FLUIDEZ2:
                //doType(83);
                doType(VK_M);
                break;
            case ButtonEnum.FLUIDEZ3:
                //doType(68);
                doType(VK_N);
                break;
            case ButtonEnum.FLUIDEZ4:
                //doType(70);
                doType(VK_O);
                break;    
            case ButtonEnum.NSFLUIDEZ:
                //doType(88);
                doType(VK_P);
                break;
                
            case ButtonEnum.VELOCIDAD1:
                //doType(84);
                doType(VK_Q);
                break;
            case ButtonEnum.VELOCIDAD2:
                //doType(89);
                doType(VK_R);
                break;
            case ButtonEnum.VELOCIDAD3:
                //doType(85);
                doType(VK_S);
                break;
            case ButtonEnum.VELOCIDAD4:
                //doType(73);
                doType(VK_T);
                break;
           case ButtonEnum.NSVELOCIDAD:
                //doType(88);
                doType(VK_U);
                break;
                
            case ButtonEnum.CURVA1:
                //doType(71);
                doType(VK_V);
                break;
            case ButtonEnum.CURVA2:
                //doType(72);
                doType(VK_W);
                break;
            case ButtonEnum.CURVA3:
                //doType(74);
                doType(VK_X);
                break;
            case ButtonEnum.CURVA4:
                //doType(75);
                doType(VK_Y);
                break;
            case ButtonEnum.NSCURVA:
                //doType(88);
                doType(VK_Z);
                break;
                
            case ButtonEnum.CONTINUAR:
                //doType(10);
                //doType(67);
                doType(VK_1);
                break;
            case ButtonEnum.REPETIR:
                //doType(144,110);
                //doType(86);
                doType(VK_2);
                break;
